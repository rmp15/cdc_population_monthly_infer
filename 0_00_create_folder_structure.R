...
project.folder = paste0(print(here::here()),'/')
  ...
  data.folder = paste0(project.folder, "data/")
    population.folder = paste0(data.folder, "population/")
      ...
      population.formatted.folder = paste0(population.folder, "formatted/")
      population.county.fixed.folder = paste0(population.folder, "county_codes_fixed/")
      ...
      population.incomplete.folder = paste0(population.folder, "incomplete/")
      population.mismatched.folder = paste0(population.folder, "mismatched/")
  ...
  output.folder = paste0(project.folder, "output/")
    population.processed.folder = paste0(output.folder, "population_processed/")
      population.5year.processed.folder = paste0(population.processed.folder, "5_year_age_groups/")
      population.10year.processed.folder = paste0(population.processed.folder, "10_year_age_groups/")
      population.race.processed.folder = paste0(population.processed.folder, "race_groups/")
      population.ethnicity.processed.folder = paste0(population.processed.folder, "ethnicity_groups/")
